...
class _RegisterState extends State<Register> {
  ...
  Widget build(BuildContext context) {
    return loading ? Loading() : Scaffold(
      ...
      appBar: BaseAppBar(titleText: 'Sign up', icon: personIcon,
                ...
                Row(
                  children: <Widget>[
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        Text("I agree that my personal data will be\nprocessed"),
  ...
  void _showBasicInfo() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Data we collect from you"),
          content: SingleChildScrollView(child: new Text("We collect data from you and others in order to provide you with this service. We keep your data safe and encrypted at all times. We will handle your data with care and we will not sell it to anyone. We are very concerned not to violate your privacy. For further information check our Privacy Policy\n\nWe collect, store and process your:\n\n- E-Mail adress\n- Password\n- Chat messages\n- Firstname\n- Lastname\n- Adress\n- Ratings\n- Device information\n- Requests\n- Profile picture")),
          actions: <Widget>[
            // usually buttons at the bottom of the dialog
            new FlatButton(
              child: new Text("Close"),
  ...
  Future registerWithEmailAndPasswordButton() async{
    if(_formKey.currentState.validate()) {
      if (hasAgreedToTermsOfUse) {
        ...
        setState(() {error = 'You must agree to the terms of service!';});
      }
    }
  }
}